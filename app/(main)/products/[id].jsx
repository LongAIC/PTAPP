...
import { useAddChatBoxMutation } from "@/serviceFTECH";
...
export default function SingleProductScreen() {
  ...
  const [addChatbox, { data }] = useAddChatBoxMutation();
  ...
  const OpenLinkZalo = (Link) => {
    Linking.openURL(Link);
  };
  const OpenLinkPhone = (Link) => {
  ...
  const goToChat = (tawk_to, brand_id) => {
    if (userInfo?.id && brand_id) {
  ...
  return (
    <>
      ...
      />
      {isLoading ? (
        <View className="h-full flex justify-center items-center bg-gray-100">
              ...
              <View className="py-2 flex gap-y-2">
                <View className=" bg-white rounded-xl px-2 pb-3">
                  ...
                  <View className="my-5 gap-2">
                    {unit?.zalo_link != undefined ? (
                      <View>
                        <TouchableOpacity
                          ...
                          onPress={() => OpenLinkZalo(unit?.zalo_link)}
                        >
                          <Image
                    ...
                    {unit?.phone_number != undefined ? (
                      <View>
                        <TouchableOpacity
                          ...
                          onPress={() => OpenLinkPhone(unit?.phone_number)}
                        >
                          <Image
                    ...
                    {unit?.tawk_to != undefined ? (
                      <View>
                        <TouchableOpacity
                          onPress={() => goToChat(unit.tawk_to, unit?.id)}
                          style={{
                            flexDirection: "row",
                            alignItems: "center",
                            justifyContent: "center",
